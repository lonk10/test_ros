...
func init() {
	...
	typemap.RegisterMessage("pendulum_msgs/msg/JointState", JointStateTypeSupport)
}
...
func JointState__Sequence_to_C(cSlice *CJointState__Sequence, goSlice []JointState) {
	...
	cSlice.data = (*C.pendulum_msgs__msg__JointState)(C.malloc(C.sizeof_struct_pendulum_msgs__msg__JointState * C.size_t(len(goSlice))))
