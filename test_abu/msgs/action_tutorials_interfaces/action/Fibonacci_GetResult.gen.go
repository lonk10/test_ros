...
func init() {
	typemap.RegisterService("action_tutorials_interfaces/Fibonacci_GetResult", Fibonacci_GetResultTypeSupport)
	typemap.RegisterService("action_tutorials_interfaces/action/Fibonacci_GetResult", Fibonacci_GetResultTypeSupport)
}
...
func (s _Fibonacci_GetResultTypeSupport) TypeSupport() unsafe.Pointer {
	return unsafe.Pointer(C.rosidl_typesupport_c__get_service_type_support_handle__action_tutorials_interfaces__action__Fibonacci_GetResult())
}
