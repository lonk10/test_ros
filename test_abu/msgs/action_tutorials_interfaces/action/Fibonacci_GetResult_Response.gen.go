...
func init() {
	typemap.RegisterMessage("action_tutorials_interfaces/Fibonacci_GetResult_Response", Fibonacci_GetResult_ResponseTypeSupport)
	typemap.RegisterMessage("action_tutorials_interfaces/action/Fibonacci_GetResult_Response", Fibonacci_GetResult_ResponseTypeSupport)
}
...
func (t _Fibonacci_GetResult_ResponseTypeSupport) PrepareMemory() unsafe.Pointer { //returns *C.action_tutorials_interfaces__action__Fibonacci_GetResult_Response
	return (unsafe.Pointer)(C.action_tutorials_interfaces__action__Fibonacci_GetResult_Response__create())
}

func (t _Fibonacci_GetResult_ResponseTypeSupport) ReleaseMemory(pointer_to_free unsafe.Pointer) {
	C.action_tutorials_interfaces__action__Fibonacci_GetResult_Response__destroy((*C.action_tutorials_interfaces__action__Fibonacci_GetResult_Response)(pointer_to_free))
}
...
func (t _Fibonacci_GetResult_ResponseTypeSupport) AsCStruct(dst unsafe.Pointer, msg types.Message) {
	...
	mem := (*C.action_tutorials_interfaces__action__Fibonacci_GetResult_Response)(dst)
...
func (t _Fibonacci_GetResult_ResponseTypeSupport) AsGoStruct(msg types.Message, ros2_message_buffer unsafe.Pointer) {
	m := msg.(*Fibonacci_GetResult_Response)
	mem := (*C.action_tutorials_interfaces__action__Fibonacci_GetResult_Response)(ros2_message_buffer)
...
func (t _Fibonacci_GetResult_ResponseTypeSupport) TypeSupport() unsafe.Pointer {
	return unsafe.Pointer(C.rosidl_typesupport_c__get_message_type_support_handle__action_tutorials_interfaces__action__Fibonacci_GetResult_Response())
}

type CFibonacci_GetResult_Response = C.action_tutorials_interfaces__action__Fibonacci_GetResult_Response
type CFibonacci_GetResult_Response__Sequence = C.action_tutorials_interfaces__action__Fibonacci_GetResult_Response__Sequence
...
func Fibonacci_GetResult_Response__Sequence_to_C(cSlice *CFibonacci_GetResult_Response__Sequence, goSlice []Fibonacci_GetResult_Response) {
	...
	cSlice.data = (*C.action_tutorials_interfaces__action__Fibonacci_GetResult_Response)(C.malloc(C.sizeof_struct_action_tutorials_interfaces__action__Fibonacci_GetResult_Response * C.size_t(len(goSlice))))
