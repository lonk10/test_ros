...
func init() {
	typemap.RegisterMessage("action_tutorials_interfaces/Fibonacci_Goal", Fibonacci_GoalTypeSupport)
	typemap.RegisterMessage("action_tutorials_interfaces/action/Fibonacci_Goal", Fibonacci_GoalTypeSupport)
}
...
func (t _Fibonacci_GoalTypeSupport) PrepareMemory() unsafe.Pointer { //returns *C.action_tutorials_interfaces__action__Fibonacci_Goal
	return (unsafe.Pointer)(C.action_tutorials_interfaces__action__Fibonacci_Goal__create())
}

func (t _Fibonacci_GoalTypeSupport) ReleaseMemory(pointer_to_free unsafe.Pointer) {
	C.action_tutorials_interfaces__action__Fibonacci_Goal__destroy((*C.action_tutorials_interfaces__action__Fibonacci_Goal)(pointer_to_free))
}

func (t _Fibonacci_GoalTypeSupport) AsCStruct(dst unsafe.Pointer, msg types.Message) {
	m := msg.(*Fibonacci_Goal)
	mem := (*C.action_tutorials_interfaces__action__Fibonacci_Goal)(dst)
...
func (t _Fibonacci_GoalTypeSupport) AsGoStruct(msg types.Message, ros2_message_buffer unsafe.Pointer) {
	m := msg.(*Fibonacci_Goal)
	mem := (*C.action_tutorials_interfaces__action__Fibonacci_Goal)(ros2_message_buffer)
	m.Order = int32(mem.order)
}

func (t _Fibonacci_GoalTypeSupport) TypeSupport() unsafe.Pointer {
	return unsafe.Pointer(C.rosidl_typesupport_c__get_message_type_support_handle__action_tutorials_interfaces__action__Fibonacci_Goal())
}

type CFibonacci_Goal = C.action_tutorials_interfaces__action__Fibonacci_Goal
type CFibonacci_Goal__Sequence = C.action_tutorials_interfaces__action__Fibonacci_Goal__Sequence
...
func Fibonacci_Goal__Sequence_to_C(cSlice *CFibonacci_Goal__Sequence, goSlice []Fibonacci_Goal) {
	...
	cSlice.data = (*C.action_tutorials_interfaces__action__Fibonacci_Goal)(C.malloc(C.sizeof_struct_action_tutorials_interfaces__action__Fibonacci_Goal * C.size_t(len(goSlice))))
