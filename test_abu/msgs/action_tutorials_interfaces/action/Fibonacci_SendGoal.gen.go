...
func init() {
	typemap.RegisterService("action_tutorials_interfaces/Fibonacci_SendGoal", Fibonacci_SendGoalTypeSupport)
	typemap.RegisterService("action_tutorials_interfaces/action/Fibonacci_SendGoal", Fibonacci_SendGoalTypeSupport)
}
...
func (s _Fibonacci_SendGoalTypeSupport) TypeSupport() unsafe.Pointer {
	return unsafe.Pointer(C.rosidl_typesupport_c__get_service_type_support_handle__action_tutorials_interfaces__action__Fibonacci_SendGoal())
}
