...
func init() {
	typemap.RegisterMessage("action_tutorials_interfaces/Fibonacci_GetResult_Request", Fibonacci_GetResult_RequestTypeSupport)
	typemap.RegisterMessage("action_tutorials_interfaces/action/Fibonacci_GetResult_Request", Fibonacci_GetResult_RequestTypeSupport)
}
...
func (t _Fibonacci_GetResult_RequestTypeSupport) PrepareMemory() unsafe.Pointer { //returns *C.action_tutorials_interfaces__action__Fibonacci_GetResult_Request
	return (unsafe.Pointer)(C.action_tutorials_interfaces__action__Fibonacci_GetResult_Request__create())
}

func (t _Fibonacci_GetResult_RequestTypeSupport) ReleaseMemory(pointer_to_free unsafe.Pointer) {
	C.action_tutorials_interfaces__action__Fibonacci_GetResult_Request__destroy((*C.action_tutorials_interfaces__action__Fibonacci_GetResult_Request)(pointer_to_free))
}
...
func (t _Fibonacci_GetResult_RequestTypeSupport) AsCStruct(dst unsafe.Pointer, msg types.Message) {
	...
	mem := (*C.action_tutorials_interfaces__action__Fibonacci_GetResult_Request)(dst)
...
func (t _Fibonacci_GetResult_RequestTypeSupport) AsGoStruct(msg types.Message, ros2_message_buffer unsafe.Pointer) {
	m := msg.(*Fibonacci_GetResult_Request)
	mem := (*C.action_tutorials_interfaces__action__Fibonacci_GetResult_Request)(ros2_message_buffer)
...
func (t _Fibonacci_GetResult_RequestTypeSupport) TypeSupport() unsafe.Pointer {
	return unsafe.Pointer(C.rosidl_typesupport_c__get_message_type_support_handle__action_tutorials_interfaces__action__Fibonacci_GetResult_Request())
}

type CFibonacci_GetResult_Request = C.action_tutorials_interfaces__action__Fibonacci_GetResult_Request
type CFibonacci_GetResult_Request__Sequence = C.action_tutorials_interfaces__action__Fibonacci_GetResult_Request__Sequence
...
func Fibonacci_GetResult_Request__Sequence_to_C(cSlice *CFibonacci_GetResult_Request__Sequence, goSlice []Fibonacci_GetResult_Request) {
	...
	cSlice.data = (*C.action_tutorials_interfaces__action__Fibonacci_GetResult_Request)(C.malloc(C.sizeof_struct_action_tutorials_interfaces__action__Fibonacci_GetResult_Request * C.size_t(len(goSlice))))
