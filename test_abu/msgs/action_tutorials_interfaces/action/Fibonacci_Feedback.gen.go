...
package action_tutorials_interfaces_action
import (
	"unsafe"
...
func init() {
	typemap.RegisterMessage("action_tutorials_interfaces/Fibonacci_Feedback", Fibonacci_FeedbackTypeSupport)
	typemap.RegisterMessage("action_tutorials_interfaces/action/Fibonacci_Feedback", Fibonacci_FeedbackTypeSupport)
}

type Fibonacci_Feedback struct {
	PartialSequence []int32 `yaml:"partial_sequence"`
}
...
func (t *Fibonacci_Feedback) Clone() *Fibonacci_Feedback {
	...
	if t.PartialSequence != nil {
		c.PartialSequence = make([]int32, len(t.PartialSequence))
		copy(c.PartialSequence, t.PartialSequence)
	}
	return c
}
...
func (t _Fibonacci_FeedbackTypeSupport) PrepareMemory() unsafe.Pointer { //returns *C.action_tutorials_interfaces__action__Fibonacci_Feedback
	return (unsafe.Pointer)(C.action_tutorials_interfaces__action__Fibonacci_Feedback__create())
}

func (t _Fibonacci_FeedbackTypeSupport) ReleaseMemory(pointer_to_free unsafe.Pointer) {
	C.action_tutorials_interfaces__action__Fibonacci_Feedback__destroy((*C.action_tutorials_interfaces__action__Fibonacci_Feedback)(pointer_to_free))
}

func (t _Fibonacci_FeedbackTypeSupport) AsCStruct(dst unsafe.Pointer, msg types.Message) {
	m := msg.(*Fibonacci_Feedback)
	mem := (*C.action_tutorials_interfaces__action__Fibonacci_Feedback)(dst)
	primitives.Int32__Sequence_to_C((*primitives.CInt32__Sequence)(unsafe.Pointer(&mem.partial_sequence)), m.PartialSequence)
}

func (t _Fibonacci_FeedbackTypeSupport) AsGoStruct(msg types.Message, ros2_message_buffer unsafe.Pointer) {
	m := msg.(*Fibonacci_Feedback)
	mem := (*C.action_tutorials_interfaces__action__Fibonacci_Feedback)(ros2_message_buffer)
	primitives.Int32__Sequence_to_Go(&m.PartialSequence, *(*primitives.CInt32__Sequence)(unsafe.Pointer(&mem.partial_sequence)))
}

func (t _Fibonacci_FeedbackTypeSupport) TypeSupport() unsafe.Pointer {
	return unsafe.Pointer(C.rosidl_typesupport_c__get_message_type_support_handle__action_tutorials_interfaces__action__Fibonacci_Feedback())
}

type CFibonacci_Feedback = C.action_tutorials_interfaces__action__Fibonacci_Feedback
type CFibonacci_Feedback__Sequence = C.action_tutorials_interfaces__action__Fibonacci_Feedback__Sequence
...
func Fibonacci_Feedback__Sequence_to_C(cSlice *CFibonacci_Feedback__Sequence, goSlice []Fibonacci_Feedback) {
	...
	cSlice.data = (*C.action_tutorials_interfaces__action__Fibonacci_Feedback)(C.malloc(C.sizeof_struct_action_tutorials_interfaces__action__Fibonacci_Feedback * C.size_t(len(goSlice))))
