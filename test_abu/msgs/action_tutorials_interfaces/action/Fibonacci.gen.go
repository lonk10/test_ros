...
func init() {
	typemap.RegisterAction("action_tutorials_interfaces/Fibonacci", FibonacciTypeSupport)
	typemap.RegisterAction("action_tutorials_interfaces/action/Fibonacci", FibonacciTypeSupport)
}
...
func (s _FibonacciTypeSupport) TypeSupport() unsafe.Pointer {
	return unsafe.Pointer(C.rosidl_typesupport_c__get_action_type_support_handle__action_tutorials_interfaces__action__Fibonacci())
}
