...
func init() {
	typemap.RegisterMessage("action_tutorials_interfaces/Fibonacci_FeedbackMessage", Fibonacci_FeedbackMessageTypeSupport)
	typemap.RegisterMessage("action_tutorials_interfaces/action/Fibonacci_FeedbackMessage", Fibonacci_FeedbackMessageTypeSupport)
}
...
func (t _Fibonacci_FeedbackMessageTypeSupport) PrepareMemory() unsafe.Pointer { //returns *C.action_tutorials_interfaces__action__Fibonacci_FeedbackMessage
	return (unsafe.Pointer)(C.action_tutorials_interfaces__action__Fibonacci_FeedbackMessage__create())
}

func (t _Fibonacci_FeedbackMessageTypeSupport) ReleaseMemory(pointer_to_free unsafe.Pointer) {
	C.action_tutorials_interfaces__action__Fibonacci_FeedbackMessage__destroy((*C.action_tutorials_interfaces__action__Fibonacci_FeedbackMessage)(pointer_to_free))
}
...
func (t _Fibonacci_FeedbackMessageTypeSupport) AsCStruct(dst unsafe.Pointer, msg types.Message) {
	...
	mem := (*C.action_tutorials_interfaces__action__Fibonacci_FeedbackMessage)(dst)
...
func (t _Fibonacci_FeedbackMessageTypeSupport) AsGoStruct(msg types.Message, ros2_message_buffer unsafe.Pointer) {
	m := msg.(*Fibonacci_FeedbackMessage)
	mem := (*C.action_tutorials_interfaces__action__Fibonacci_FeedbackMessage)(ros2_message_buffer)
...
func (t _Fibonacci_FeedbackMessageTypeSupport) TypeSupport() unsafe.Pointer {
	return unsafe.Pointer(C.rosidl_typesupport_c__get_message_type_support_handle__action_tutorials_interfaces__action__Fibonacci_FeedbackMessage())
}

type CFibonacci_FeedbackMessage = C.action_tutorials_interfaces__action__Fibonacci_FeedbackMessage
type CFibonacci_FeedbackMessage__Sequence = C.action_tutorials_interfaces__action__Fibonacci_FeedbackMessage__Sequence
...
func Fibonacci_FeedbackMessage__Sequence_to_C(cSlice *CFibonacci_FeedbackMessage__Sequence, goSlice []Fibonacci_FeedbackMessage) {
	...
	cSlice.data = (*C.action_tutorials_interfaces__action__Fibonacci_FeedbackMessage)(C.malloc(C.sizeof_struct_action_tutorials_interfaces__action__Fibonacci_FeedbackMessage * C.size_t(len(goSlice))))
