...
func init() {
	typemap.RegisterMessage("action_tutorials_interfaces/Fibonacci_Result", Fibonacci_ResultTypeSupport)
	typemap.RegisterMessage("action_tutorials_interfaces/action/Fibonacci_Result", Fibonacci_ResultTypeSupport)
}

type Fibonacci_Result struct {
	Sequence []int32 `yaml:"sequence"`
}
...
func (t _Fibonacci_ResultTypeSupport) PrepareMemory() unsafe.Pointer { //returns *C.action_tutorials_interfaces__action__Fibonacci_Result
	return (unsafe.Pointer)(C.action_tutorials_interfaces__action__Fibonacci_Result__create())
}

func (t _Fibonacci_ResultTypeSupport) ReleaseMemory(pointer_to_free unsafe.Pointer) {
	C.action_tutorials_interfaces__action__Fibonacci_Result__destroy((*C.action_tutorials_interfaces__action__Fibonacci_Result)(pointer_to_free))
}

func (t _Fibonacci_ResultTypeSupport) AsCStruct(dst unsafe.Pointer, msg types.Message) {
	m := msg.(*Fibonacci_Result)
	mem := (*C.action_tutorials_interfaces__action__Fibonacci_Result)(dst)
...
func (t _Fibonacci_ResultTypeSupport) AsGoStruct(msg types.Message, ros2_message_buffer unsafe.Pointer) {
	m := msg.(*Fibonacci_Result)
	mem := (*C.action_tutorials_interfaces__action__Fibonacci_Result)(ros2_message_buffer)
...
func (t _Fibonacci_ResultTypeSupport) TypeSupport() unsafe.Pointer {
	return unsafe.Pointer(C.rosidl_typesupport_c__get_message_type_support_handle__action_tutorials_interfaces__action__Fibonacci_Result())
}

type CFibonacci_Result = C.action_tutorials_interfaces__action__Fibonacci_Result
type CFibonacci_Result__Sequence = C.action_tutorials_interfaces__action__Fibonacci_Result__Sequence
...
func Fibonacci_Result__Sequence_to_C(cSlice *CFibonacci_Result__Sequence, goSlice []Fibonacci_Result) {
	...
	cSlice.data = (*C.action_tutorials_interfaces__action__Fibonacci_Result)(C.malloc(C.sizeof_struct_action_tutorials_interfaces__action__Fibonacci_Result * C.size_t(len(goSlice))))
