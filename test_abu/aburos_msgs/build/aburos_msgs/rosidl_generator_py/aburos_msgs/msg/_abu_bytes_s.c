...
bool aburos_msgs__msg__abu_bytes__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("aburos_msgs.msg._abu_bytes.AbuBytes", full_classname_dest, 35) == 0);
  }
  aburos_msgs__msg__AbuBytes * ros_message = _ros_message;
  {  // data
...
{
  /* NOTE(esteve): Call constructor of AbuBytes */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("aburos_msgs.msg._abu_bytes");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "AbuBytes");
