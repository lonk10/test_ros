...
#include "aburos_msgs/msg/detail/abu_ros__type_support.h"
...
static const _AbuRos_type_support_symbol_names_t _AbuRos_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, aburos_msgs, msg, AbuRos)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, aburos_msgs, msg, AbuRos)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, aburos_msgs, msg, AbuRos)() {
  return &::aburos_msgs::msg::rosidl_typesupport_c::AbuRos_message_type_support_handle;
}
