...
static const _AbuRule_type_support_symbol_names_t _AbuRule_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, aburos_msgs, msg, AbuRule)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, aburos_msgs, msg, AbuRule)),
  }
};
...
{
  return &::aburos_msgs::msg::rosidl_typesupport_cpp::AbuRule_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, aburos_msgs, msg, AbuRule)() {
  return get_message_type_support_handle<aburos_msgs::msg::AbuRule>();
}
