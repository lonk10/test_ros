...
bool aburos_msgs__msg__abu_ros__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("aburos_msgs.msg._abu_ros.AbuRos", full_classname_dest, 31) == 0);
  }
  aburos_msgs__msg__AbuRos * ros_message = _ros_message;
  {  // data
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * aburos_msgs__msg__abu_ros__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of AbuRos */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("aburos_msgs.msg._abu_ros");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "AbuRos");
  ...
  aburos_msgs__msg__AbuRos * ros_message = (aburos_msgs__msg__AbuRos *)raw_ros_message;
  {  // data
    PyObject * field = NULL;
