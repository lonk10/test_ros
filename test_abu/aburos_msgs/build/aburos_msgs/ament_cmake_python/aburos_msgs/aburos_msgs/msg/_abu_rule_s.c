...
bool aburos_msgs__msg__abu_rule__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("aburos_msgs.msg._abu_rule.AbuRule", full_classname_dest, 33) == 0);
  }
  aburos_msgs__msg__AbuRule * ros_message = _ros_message;
  {  // condition
  ...
  {  // local_resources
    PyObject * field = PyObject_GetAttrString(_pymsg, "local_resources");
    if (!field) {
      return false;
    }
    {
  ...
  {  // remote_resources
    PyObject * field = PyObject_GetAttrString(_pymsg, "remote_resources");
    if (!field) {
      return false;
    }
    {
      PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'remote_resources'");
      if (!seq_field) {
        Py_DECREF(field);
        return false;
      }
      ...
      rosidl_runtime_c__String * dest = ros_message->remote_resources.data;
      for (Py_ssize_t i = 0; i < size; ++i) {
        PyObject * item = PySequence_Fast_GET_ITEM(seq_field, i);
        if (!item) {
          Py_DECREF(seq_field);
...
{
  /* NOTE(esteve): Call constructor of AbuRule */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("aburos_msgs.msg._abu_rule");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "AbuRule");
  ...
  {  // local_resources
    ...
    assert(PySequence_Check(field));
    {
      int rc = PyObject_SetAttrString(_pymessage, "local_resources", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // remote_resources
    ...
    rosidl_runtime_c__String * src = ros_message->remote_resources.data;
    field = PyList_New(size);
    if (!field) {
      return NULL;
    }
    ...
    assert(PySequence_Check(field));
    {
      int rc = PyObject_SetAttrString(_pymessage, "remote_resources", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
